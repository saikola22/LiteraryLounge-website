...
import logo from "../../asset/Capturenew2.PNG";
  ...
  return (
    ...
    >
      <div className="container-fluid">
          ...
          <img src={logo} alt="Logo"  height="65px" className="image-fluid"/> 
          {/* <span className="ms-2" style={{ color: "white" }} >Literary Lounge</span> */}
        </a>
